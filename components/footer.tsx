  ...
  return (
    <footer
      ...
      style={{
        ...
        borderColor: "rgba(248, 164, 184, 0.15)",
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
          ...
          <div className="flex flex-col items-center gap-3 md:items-start">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold" style={{ color: "#9e3a5c" }}>
                {"Sugar"}<span style={{ color: "#e8789a" }}>{"Radio"}</span>
              </span>
            </div>
            <p className="max-w-xs text-center text-sm md:text-left" style={{ color: "#b05070" }}>
              {t("footer.desc")}
            </p>
          </div>
          ...
          <div className="flex gap-12">
            <div className="flex flex-col gap-3">
              <h4 className="text-sm font-semibold" style={{ color: "#9e3a5c" }}>{t("footer.nav")}</h4>
              {[
                ...
                <Link key={link.href} href={link.href} className="text-sm transition-colors" style={{ color: "#b05070" }}>
                  {t(link.key)}
                </Link>
              ))}
            </div>
            <div className="flex flex-col gap-3">
              <h4 className="text-sm font-semibold" style={{ color: "#9e3a5c" }}>{t("footer.social")}</h4>
        ...
        {/* Bottom */}
        <div className="mt-8 border-t pt-8 text-center" style={{ borderColor: "rgba(248, 164, 184, 0.15)" }}>
